...
const ALL_FILMS = [...FILMS, ...FILMS_B2];
          ...
          <div style={S.modal} onClick={()=>setSelectedFilm(null)}>
            <div style={S.modalBox} onClick={e=>e.stopPropagation()}>
              ...
              <div style={S.mMeta}>
                ...
                <span style={S.mMetaH}>Where to see:</span> {selectedFilm.watchOn || selectedFilm.value}
              </div>
              <div style={S.mDesc}>{selectedFilm.description}</div>
              <div style={{display:"flex",gap:8,flexWrap:"wrap",marginTop:8}}>
                {selectedFilm.imdb && (
                  <a href={selectedFilm.imdb} target="_blank" rel="noopener noreferrer"
                    style={{...S.actionBtn,background:"#1A1200",color:"#F5C518",border:"1px solid #F5C51844"}}
                    onClick={e=>e.stopPropagation()}>IMDb</a>
                )}
                {selectedFilm.watchOn && selectedFilm.watchOn.startsWith("http") && (
                  <a href={selectedFilm.watchOn} target="_blank" rel="noopener noreferrer"
