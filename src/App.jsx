...
const ALL_FILMS = [...FILMS, ...FILMS_B2, ...FILMS_B3, ...FILMS_B4, ...FILMS_B5];
        ...
        <div style={S.landing}>
          ...
          <div style={S.sectionCard} onClick={() => setSection("films")}>
            ...
            <div>
              ...
              <div style={S.sectionCardSub}>Top {ALL_FILMS.length} films by era{"\n"}Independent theaters worldwide</div>
            ...
            <div style={S.modalBox} onClick={e=>e.stopPropagation()}>
              ...
              <div style={S.mMeta}>
                ...
                {selectedFilm.screenplay && (
                  <><span style={S.mMetaH}>Screenplay:</span> {selectedFilm.screenplay}<br/></>
                )}
                {selectedFilm.soundtrack && (
                  <><span style={S.mMetaH}>Soundtrack:</span> {selectedFilm.soundtrack}<br/></>
                )}
              ...
              <div style={S.modalBox} onClick={e=>e.stopPropagation()}>
                ...
                <div style={{display:"flex",gap:14,alignItems:"flex-start",marginBottom:14}}>
                  <div style={{flexShrink:0}}>
                    <ArtistImage artist={a} size={128} />
                    <div style={{fontSize:8,color:"#333",textAlign:"center",marginTop:4,letterSpacing:"0.08em"}}>
